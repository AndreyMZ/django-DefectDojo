...
class FindingViewSet(mixins.ListModelMixin,
    ...
    filter_fields = {
        ...
        'severity': ['exact'],
        'description': ['exact'],
        'mitigated': ['exact', 'isnull', 'gt', 'gte', 'lt', 'lte'],
        'endpoints': ['exact'],
        'test': ['exact'],
        'active': ['exact'],
        'verified': ['exact'],
        ...
        'test__engagement__target_start': ['exact', 'gt', 'gte', 'lt', 'lte'],
        'test__engagement__target_end': ['exact', 'gt', 'gte', 'lt', 'lte'],
        'test__test_type': ['exact'],
        'test__target_start': ['exact', 'gt', 'gte', 'lt', 'lte'],
        'test__target_end': ['exact', 'gt', 'gte', 'lt', 'lte'],
...
class TestTypesViewSet(mixins.ListModelMixin,
    ...
    filter_backends = (DjangoFilterBackend,)
    filter_fields = ('id', 'name', 'static_tool', 'dynamic_tool')
