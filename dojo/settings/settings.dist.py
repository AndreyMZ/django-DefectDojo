...
env = environ.Env(
    ...
    DD_SOCIAL_AUTH_GOOGLE_OPENIDCONNECT_KEY=(str, None),
    DD_SOCIAL_AUTH_GOOGLE_OPENIDCONNECT_SECRET=(str, None),
    DD_SOCIAL_AUTH_OKTA_OAUTH2_KEY=(str, None),
    DD_SOCIAL_AUTH_OKTA_OAUTH2_SECRET=(str, None),
    DD_SOCIAL_AUTH_OKTA_OAUTH2_API_URL=(str, None), # Example: https://{your-org-url}/oauth2/default
    DD_SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_KEY=(str, None),
    DD_SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_SECRET=(str, None),
    DD_SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_TENANT_ID=(str, None),
    ...
    DD_SOCIAL_AUTH_WHITELISTED_DOMAINS=(list, None),
)
...
SOCIAL_AUTH_WHITELISTED_DOMAINS = env('DD_SOCIAL_AUTH_WHITELISTED_DOMAINS')
SOCIAL_AUTH_SANITIZE_REDIRECTS = True
SOCIAL_AUTH_REDIRECT_IS_HTTPS = True
SOCIAL_AUTH_SESSION_EXPIRATION = True
SOCIAL_AUTH_REVOKE_TOKENS_ON_DISCONNECT = True
# https://python-social-auth.readthedocs.io/en/latest/backends/google.html#user-identification
...
LOGIN_GOOGLE_ENABLED = (SOCIAL_AUTH_GOOGLE_OPENIDCONNECT_KEY is not None) and\
                       (SOCIAL_AUTH_GOOGLE_OPENIDCONNECT_SECRET is not None)
...
LOGIN_OKTA_ENABLED = (SOCIAL_AUTH_OKTA_OAUTH2_KEY is not None) and\
                     (SOCIAL_AUTH_OKTA_OAUTH2_SECRET is not None) and\
                     (SOCIAL_AUTH_OKTA_OAUTH2_API_URL is not None)
...
LOGIN_AZUREAD_TENANT_ENABLED = (SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_KEY is not None) and\
                               (SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_SECRET is not None) and\
                               (SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_TENANT_ID is not None) and\
                               (SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_RESOURCE is not None)
