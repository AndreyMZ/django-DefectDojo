...
def get_severities_by_month(findings, today):
    ...
    # Ths chart expects a, b, c, d, e instead of Critical, High, ...
    SEVERITY_MAP = {
        'Critical': 'a',
        'High':     'b',
        'Medium':   'c',
    ...
    for ms in severities_by_month:
        ...
        month_stats = results.setdefault(key, {'y': key, 'a': 0, 'b': 0, 'c': 0, 'd': 0, 'e': 0})
        month_stats[SEVERITY_MAP[ms['severity']]] = ms['count']
